...
public class ShootFuel extends Command {
    ...
    public void execute() {
        ...
        if (alliance.isPresent()) { // TODO SWITCH TAG POSES TO OVERSETTED ONES TO HUB
            targetPosition = (alliance.get() == Alliance.Blue) ? field.getTagPose(26).getTranslation()
                    : field.getTagPose(10).getTranslation();
        } else {
